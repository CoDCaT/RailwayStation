...
public class CitiesTo extends RealmObject {
    ...
    public CitiesTo(int cityId, String countryTitle, Point point, String districtTitle, String cityTitle, String regionTitle, RealmList<Station> stations) {
        this.cityId = cityId;
